...
describe "post" do
  it "has a published_status field" do
    @post = Post.create(title: "My Post", description: "My post desc", published_status: "true")
    expect(@post.published_status).to eq("true")
  end
end
